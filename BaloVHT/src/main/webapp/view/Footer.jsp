    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-lg-4 col-xl-3">
                ...
                <p class="mb-0">
                   Công ty của chúng tôi đã thành lập được 10 năm và
					cung cấp hàng chất lượng chính hãng đến toàn thể khách hàng.
                </p>
            </div>
            ...
            <div class="col-12 copyright mt-3">
                ...
                <p class="text-right text-muted">created withs <i class="fa fa-heart"></i> by <a href="https://t-php.fr/43-theme-ecommerce-bootstrap-4.html"><i>t-php</i></a> | <span>v. 1.0</span></p>
            </div>
        </div>
    </div>
</footer>